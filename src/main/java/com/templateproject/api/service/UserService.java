...
import com.templateproject.api.repository.UserValidationRepository;
...
import static com.templateproject.api.service.IdentityServiceException.Reason.*;
...
public class UserService {
    ...
    public User signIn(String username, String pass) throws IdentityServiceException {
        User user = (User) userRepository.findByUsername(username).orElseThrow(() -> new IdentityServiceException(BAD_LOGIN, "Unknown Email"));
    ...
    public User signUpUser(String username, String pass, boolean isTest) throws IdentityServiceException, AuthenticationFailedException {
        ...
        Optional<Object> foundUser = userRepository.findByUsername(username);
    ...
    public Optional<Object> findUser(String username) {
